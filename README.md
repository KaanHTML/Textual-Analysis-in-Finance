...
The four steps listed below show an overview of how I conducted a textual analysis the annual reports (10-Ks). In each of the programming files you can find a more detailed description of each step. 
